...
const App = () => {
  ...
  const copyTask = [...task]  // Creates a copy of task array
  copyTask.push({ title, details })  // Adds new note object to copy
  
  setTask(copyTask)  // Updates state with new array
  setTitle('')  // Clears title input
  setDetails('')  // Clears details textarea
}
  ...
  const deleteNote = (idx) => {
    ...
    setTask(copyTask)
    /*React needs to detect state changes. Directly modifying the original array won't trigger a re-render. Creating a new array tells React "state changed, re-render the component."*/
  }
